...
def git():
    ...
    try:
        repo = Repo()
        LOGGER("Zergio").info(f"Git Client Found")
    except GitCommandError:
        LOGGER("Zergio").info(f"Invalid Git Command")
        ...
        LOGGER("Zergio").info("Fetched Latest Updates")
    ...
    if is_heroku:
        if HEROKU_API_KEY and HEROKU_APP_NAME:
            try:
                ...
                LOGGER("Zergio").info(f"Heroku App Configured")
