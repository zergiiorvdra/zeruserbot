...
from Zergio import CMD_HELP, StartTime
from Zergio.helpers.basic import edit_or_reply
from Zergio.helpers.PyroHelpers import ReplyCheck
from Zergio.helpers.SQL.globals import gvarstatus
from Zergio.helpers.tools import convert_to_image
from Zergio.utils import get_readable_time
...
modules = CMD_HELP
alive_logo = (
    gvarstatus("ALIVE_LOGO") or "https://telegra.ph//file/056dde49b15dd4f88eeac.jpg"
)
...
async def alive(client: Client, message: Message):
    ...
    man = (
        f"**༺ [zerxsep](https://github.com/zergiiorvdra/zeruserbot) ༻**\n\n"
        f"<b>{alive_text}</b>\n\n"
        ...
        f"    **『 [𝗦𝘂𝗽𝗽𝗼𝗿𝘁](https://t.me/cari_teman_virtualx)** | **[𝗖𝗵𝗮𝗻𝗻𝗲𝗹](https://t.me/{CHANNEL})** | **[𝗢𝘄𝗻𝗲𝗿](tg://user?id={client.me.id}) 』**"
    )
    try:
